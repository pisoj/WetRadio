...
$total_recordings_stmt = $conn->prepare("SELECT count(*) FROM show_recordings WHERE show_item_id = :id AND datetime <= replace(datetime('now', 'localtime'), ' ', 'T')");
