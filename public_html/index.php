...
<body>
  ...
  <?php if ($preferences_string["header_message"] ?? ''): ?>
    <header class="<?= $preferences_string["header_variant"] ?>">
  ...
  <div class="page">
    <section id="form">
      ...
      if ($preferences_string['title_above_sends'] ?? '') {
        echo "<h3 style=\"text-align: center\">{$preferences_string['title_above_sends']}</h3>";
      }
      ?>
      <?php
